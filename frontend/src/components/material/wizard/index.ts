/**
 * Material-Wizard Komponenten
 * Wiederverwendbar für MaterialCreateWizard und MaterialDetailView (Bearbeiten)
 */
...
export { default as MaterialNameInput } from './MaterialNameInput.vue'
export { default as MaterialTypeToggles } from './MaterialTypeToggles.vue'
