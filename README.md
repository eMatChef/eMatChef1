...
Sollten Sie bei der Einrichtung auf Probleme stoßen oder Fragen haben, keine Sorge, wir helfen Ihnen gerne weiter. Sie können auf unserem [Community-Discord-Server](https://discord.gg/sKPZ4ZSs) um Hilfe bitten. Wir unterstützen Sie bestmöglich bei der Einrichtung und dem Start.

Bevor Sie mit dem Programmieren beginnen, lesen Sie bitte unsere [Richtlinien für Mitwirkende](CONTRIBUTING.md).

- Machen Sie sich mit der [Dokumentation im Wiki](https://https://github.com/eMatChef/eMatChef1/wiki) vertraut.
