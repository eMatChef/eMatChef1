...
final class Version20260208180000 extends AbstractMigration
{
            ...
            BEGIN
                ...
                LEFT JOIN (
                    ...
                    WHERE a.department_id = p_department_id
                      ...
                      -- Zeitraum-Overlap: Material-Zeitraum (planning_start/end) oder Nutzungs-Zeitraum
                      AND (
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE activity_item DROP CONSTRAINT FK_activity_item_activity');
        $this->addSql('ALTER TABLE activity_item DROP CONSTRAINT FK_activity_item_material');
