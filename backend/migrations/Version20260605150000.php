...
final class Version20260605150000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE material_item ADD repair_template_key VARCHAR(50) DEFAULT NULL');
        $this->addSql('CREATE INDEX idx_material_repair_template_key ON material_item (repair_template_key)');
    }
